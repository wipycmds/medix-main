...
// }
class LabsVisitCardModel {
  const LabsVisitCardModel({
    required this.id,
    required this.name,
    // this.deletedAt,
    // this.parentId,
  ...
  factory LabsVisitCardModel.fromMap(Map<String, dynamic> map) {
    return LabsVisitCardModel(
      id: map['id'] as int,
