          ...
          child: ListView(
            children: [
              ...
              Divider(
                ...
                thickness: 2.h,
                color: isLight
                    ? const Color(0xffC7C7C7).withOpacity(.15)
...
class StarFilterWrapper extends StatelessWidget {
  const StarFilterWrapper({Key? key}) : super(key: key);
            ...
            children: [
              Text.rich(TextSpan(children: [
                ...
                TextSpan(
                  ...
                  style: FontStyleUtilities.h2(
                          fontWeight: FWT.medium,
                          fontColor: const Color(0xffc7c7c7))
                      .copyWith(fontSize: 28.sp),
                ),
              ])),
              IconWrapper(
